...
## Project Structure
    ...
    ├── business_intelligen_38179  # Django project configurations
...
1. Clone this repo and `cd business_intelligen_38179`
...
2. Clone this repo and `cd business_intelligen_38179`
